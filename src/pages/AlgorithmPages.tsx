...
const getDefaultValues = (title: string, mode: Mode): readonly number[] => {
  ...
  // возрастающая последовательность вырождает обычное BST в цепочку,
  // поэтому на ней хорошо видны повороты АВЛ-дерева
  if (title.includes('Сбалансированное')) return [10, 20, 30, 40, 50, 60, 70];
